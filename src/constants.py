...
GENE_IDS = f"{INTERIM}/gene_ids.tsv"
...
CANONICAL_CDS_GENE_IDS = f"{FINAL}/canonical_gene_ids.txt"
CANONICAL_CDS_TRANSCRIPT_IDS = f"{FINAL}/canonical_transcript_ids.txt"
CANONICAL_CDS_GENE_SYMBOLS = f"{FINAL}/canonical_gene_symbols.txt"
